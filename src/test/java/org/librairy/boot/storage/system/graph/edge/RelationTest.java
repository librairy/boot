...
import org.librairy.boot.model.domain.relations.AppearedIn;
...
import org.librairy.boot.model.domain.relations.SimilarToDocuments;
...
public class RelationTest {
    ...
    public void insertSimilarTo(){
        ...
        udm.find(Relation.Type.SIMILAR_TO_DOCUMENTS)
                .from(Resource.Type.DOMAIN, domain.getUri())
                .parallelStream()
