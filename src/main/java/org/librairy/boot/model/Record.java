...
public class Record {
    ...
    // Time
    public static final String TIME                             = joiner.join(RESOURCE,"time");

    // File
    private static final String ARGUMENT                        = joiner.join(RESOURCE,"argument");
    ...
    // Domain
    private static final String DOMAIN                          = joiner.join(RESOURCE,"domain");
    public static final String DOMAIN_URI                       = joiner.join(DOMAIN, "uri");

    // Source
    private static final String SOURCE                          = joiner.join(RESOURCE,"source");
    ...
    // Publication
    private static final String PUBLICATION                     = joiner.join(RESOURCE,"publication");
