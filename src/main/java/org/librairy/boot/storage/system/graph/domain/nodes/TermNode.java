...
import org.librairy.boot.storage.system.graph.domain.edges.EmbeddedInEdge;
import org.librairy.boot.storage.system.graph.domain.edges.PairsWithEdge;
    ...
    public void add(Edge edge) {
        switch(edge.getType()){
            ...
            case PAIRS_WITH:
                ...
                break;
            default: throw new RuntimeException( "Relation " + edge + " not handled from Word Node to be added");
        }
    }
    ...
    public void remove(Edge edge) {
        switch(edge.getType()){
            ...
            case PAIRS_WITH:
                ...
                break;
            default: throw new RuntimeException( "Relation " + edge + " not handled from Word Node to be removed");
        }
    }
}
