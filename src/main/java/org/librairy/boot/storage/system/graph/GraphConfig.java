...
package org.librairy.boot.storage.system.graph;
 ...
 */
@Configuration("org.librairy.boot.storage.system.graph")
@ComponentScan({
        "org.librairy.boot.storage.system.graph",
        "org.librairy.boot.storage.generator"
})
@EnableNeo4jRepositories(basePackages = {"org.librairy.boot.storage.system.graph.repository"})
...
public class GraphConfig extends Neo4jConfiguration {
    ...
    public SessionFactory getSessionFactory() {
        ...
        return new SessionFactory(getConfiguration(),"org.librairy.boot.storage.system.graph.domain");
    }
